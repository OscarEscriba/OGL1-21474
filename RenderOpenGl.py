...
skyboxTextures = ['Textures\Skybox_Textures\skybox_right.png',
                  'Textures\Skybox_Textures\skybox_left.png',
                  'Textures\Skybox_Textures\skybox_top.png',
                  'Textures\Skybox_Textures\skybox_bottom.png',
                  'Textures\Skybox_Textures\skybox_front.png',
                  'Textures\Skybox_Textures\skybox_back.png']

renderer.CreateSkybox(textureLIst=skyboxTextures,
                      vShader=skybox_vertex_shader,
                      fShader=skybox_fragment_shader)

faceModel = Model('model1.obj')
faceModel.AddTextures('Textures\model (1).bmp')
